...
module.exports = StreamedOutgoingFrame;

require('util').inherits(StreamedOutgoingFrame, Writable);

function StreamedOutgoingFrame(socket, type) {
	this.started = false;
	this.finished = false;
	this.dataSent = false;
	this.type = type;
...
StreamedOutgoingFrame.prototype._start = function() {
	if (this.started) {
		return;
	}
...
StreamedOutgoingFrame.prototype._emptyQueue = function(end) {
...
StreamedOutgoingFrame.prototype.write = function() {
...
StreamedOutgoingFrame.prototype._write = function(chunk, encoding, callback) {
...
StreamedOutgoingFrame.prototype.end = function() {
