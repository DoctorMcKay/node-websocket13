...
module.exports = StreamedIncomingFrame;

require('util').inherits(StreamedIncomingFrame, Readable);

function StreamedIncomingFrame(frame, dispatch) {
	this.frameHeader = {};
...
StreamedIncomingFrame.prototype._read = function(size) {
	this._reading = true;
	this._dispatch();
};

StreamedIncomingFrame.prototype._frame = function(frame) {
	this._frames.push(frame);
	this._dispatch();
};

StreamedIncomingFrame.prototype._dispatch = function() {
